...
def _slice_rows_at_bin(
    ...
    *,
    ...
    return {
        "p0": p0,
        "step": step,
        "n_steps": step.astype(np.float32, copy=False),
        "gamma_rf": np.asarray(rows["gamma_rf"], dtype=np.float32),
    ...
    for obs_bin in range(nb):
        ...
        meta = {
            ...
            "fields": (
                ...
                "gamma_rf,n_steps=global ssRF event params (n_steps=macro-steps applied)"
            ),
            "pq_calibrated": True,
