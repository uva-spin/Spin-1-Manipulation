...
# Per-bin trajectory generation uses a single fixed power and burn length.
GAMMA_RF_MIN = 10.0
GAMMA_RF_MAX = 10.0
GAMMA_RF_STEP = 10.0
MIN_BURN_STEPS = 100
...
SSRF_GAMMA_RF = 50.0  # demo / single-shot default
SSRF_MAX_STEPS = 50  # alias of MAX_BURN_STEPS for CLI compatibility
...
def burn_bin_position(bin_idx: int) -> Optional[int]:
