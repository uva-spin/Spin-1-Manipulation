"""
Unmanipulated per-bin lineshape NPZs using the frozen Dulya fit.

Equilibrium spectra always come from ``GenerateDulyaLineshape`` / ``fit.py``
(``site_transition_components``, Q-meter gain, baseline, ΣPs = P).

Examples:
  python Data_Creation/dulya_fit/unmanipulated_bin_lineshape.py
  python Data_Creation/dulya_fit/unmanipulated_bin_lineshape.py --bin-idx 172
"""
...
from bin_setup import (  # noqa: E402
    LINESHape_MODEL,
...
from common import F_MAX, F_MIN, NUM_BINS, P_MAX, P_MIN, P_STEP, UNMANIP_TRAIN_DIR  # noqa: E402
...
def run_all_bins(
    *,
    ...
    print(
        f"Generating Dulya unmanipulated lineshapes: "
...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description="Dulya-fit unmanipulated per-bin lineshape generator"
    )
    p.add_argument(
        "--bin-idx",
        type=int,
